...
.contenedor-fluid {
  ...
  <div class="head">
    <ul class="nav nav-pills"  >
      <li><img src="../images/LOGO KLIMACOL.jpg" style="border-radius:5px;width: 100px;margin: 10px;"></li>       <li style="visibility: hidden;">-</li>
...
<?php 
$jorge=conectar();
$registros=$jorge->query("select codigoCargo,NombreCargo,Descripcion from cargo order by codigoCargo asc")or
die($jorge->error);
