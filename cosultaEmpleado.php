...
<fieldset>
<legend>Ingrese el Documento del
 Empleado a consultar:</legend>
<input type="number" name="Documento" style="margin-left:100px;border-radius: 5px;" placeholder="Documento"  required>
<br>
<br> 
